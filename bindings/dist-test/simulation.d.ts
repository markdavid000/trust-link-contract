 ...
 */
export declare function simulateAndCatch<T>(call: () => T | Promise<T>): Promise<SimulationResult<T>>;
/**
 ...
 */
export declare function assertSimulationSucceeds<T>(call: () => T | Promise<T>): Promise<T>;
/**
 * Type guard narrowing a {@link SimulationResult} to its failure variant.
 */
export declare function isSimulationError<T>(result: SimulationResult<T>): result is Extract<SimulationResult<T>, {
    ok: false;
}>;
/**
 ...
 * ```
 */
export declare function createEscrowSimulator(transport: ContractTransport): SimulationTransport;
