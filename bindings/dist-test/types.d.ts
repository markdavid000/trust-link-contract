...
export type ContractEventPayload = {
    ...
    topic: "protocol_fee_updated";
    data: ProtocolFeeUpdated;
} | {
    topic: "arbitration_fee_updated";
    data: ArbitrationFeeUpdated;
} | {
    topic: "admin_rotated";
    data: AdminRotated;
} | {
    topic: "contract_initialized";
    data: ContractInitialized;
} | {
    topic: "contract_paused";
    data: ContractPausedEvent;
} | {
    topic: "contract_unpaused";
    data: ContractUnpausedEvent;
} | {
    ...
    topic: "escrow_shipped";
    data: EscrowShipped;
} | {
    topic: "delivery_recorded";
    data: DeliveryRecorded;
} | {
    topic: "escrow_completed";
    data: EscrowCompleted;
} | {
    topic: "escrow_cancelled";
    data: EscrowCancelled;
} | {
    ...
    topic: "resolver_rotated";
    data: ResolverRotated;
};
